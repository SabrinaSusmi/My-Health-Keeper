...
const { postFood, getFood, deleteFood, getFoodMenu ,getDietSummaryOfTheDay,getFoodHistory, burnCalorie} = require('../controllers/dietPlan.Controller/consumedCalorie.controller')
