...
const { postFood, getFood, deleteFood, getFoodMenu ,getDietSummaryOfTheDay,getFoodHistory} = require('../controllers/dietPlan.Controller/consumedCalorie.controller')
